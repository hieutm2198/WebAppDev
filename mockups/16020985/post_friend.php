		...
		<div class="row">
			...
			<div id="middle-content" class="col-6 mt-3" style="padding: 20px;">
				<div class="media">
					...
					?>"
					alt="Image_User" class="mr-2 rounded-circle" width="60px;">
				...
				<div class="mt-0 p-4 border" style="border-radius: 7px; box-shadow: 0 1px 1px 0 rgba(0, 0, 0, 0.1), 0 2px 6px 0 rgba(0, 0, 0, 0.19);">
					<form method="post" action="post_friend.php">
								...
								echo "<div class='media mb-4'>
										<div class='ml-auto small mr-3'>
											<ul class='list-unstyled'>
                                                <li><a href='server4.php?tanglike=like_cmt" .$idbinhluan. "' style='color: rgb(84, 84, 84);'>
                                                <i id='like_cmt" .$idbinhluan. "' class='fas fa-caret-up fa-2x'></i></a></li>
												<li>" .$count_like_cmt. "</li>
                                                <li><a href='server4.php?giamlike=dislike_cmt" .$idbinhluan. "' style='color: rgb(84, 84, 84);'>
                                                <i id='dislike_cmt" .$idbinhluan. "' class='fas fa-caret-down fa-2x'></i></a></li>
											</ul>
										</div>
												...
												while($arr_info_rep_cmt = mysqli_fetch_assoc($result3)) {
													...
													echo "<div class='media border-left' style='position: relative; left: -20px'>
															<div class='ml-auto small mr-3 pl-2'>
																<ul class='list-unstyled'>
                                                                    <li><a href='server4.php?tanglike1=like_rep_cmt" .$idtraloi. "' style='color: rgb(84, 84, 84);'>
                                                                    <i class='fas fa-caret-up fa-2x'></i></a></li>
																	<li>" .$like_rep_cmt. "</li>
                                                                    <li><a href='server4.php?giamlike1=dislike_rep_cmt" .$idtraloi. "' style='color: rgb(84, 84, 84);'>
                                                                    <i class='fas fa-caret-down fa-2x'></i></a></li>
																</ul>
															</div>
															<img src='image/" .$anh_sv. "' alt='Image_User' class='mr-2 mt-2 rounded-circle' width='40px'>
															<div class='media-body'>
									...
									echo  "</div>	
											...
											<div style='display: none'>
												<form method='post' action='post_friend.php' class='ml-5'>
												...
												<img style='position: relative; top: -48px; left: 40px;' src='image/" .$_SESSION['anh']. "' alt='Image_User' class='mr-2 mt-2 rounded-circle' width='40px'>
											</div>";
							}
						}
					?>
