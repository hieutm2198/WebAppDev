<?php
    ...
    if(mysqli_num_rows($result) > 0) {
        while($row=mysqli_fetch_assoc($result)) {
            ...
            echo "<div class='card' style='width: 100%; padding: 20px; margin-top: 20px;'>
                    ...
                    <div class='card-body' style='padding: 0;'>
                        <img class='img-fluid' src='image/" .$anh_post. "' alt='Image_Post'> 
                        <p class='mt-3'><a href='server.php?detail_post=" .$id_post. "' style='text-decoration: none; font-size: 22px; font-weight: 500;'>" .$tieude_post. "</a></p>
                    </div>    
