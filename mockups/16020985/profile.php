        ...
        <div class="right_content" style="float: left; position: relative;">
            ...
            <div id="history_user" style="display: none; position: absolute; padding: 20px;">
                ...
                <div class="card mb-4" style="word-spacing: 1px; line-height: 30px">
                    <div class="card-header" style="font-weight: 500">Nội dung</div>
                    <div class="card-body"><?php echo $noidung; ?></div>
                    <div class="card-footer" style="font-weight: 500"><?php echo $time; ?></div>
                </div>
                <?php
                        }
                    }
