...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/B014.css">
        <link rel="stylesheet" href="css/global.css">
        <script>
        <?php
            echo 'var surveyId = ' . $surveyId . ';';
        ?>
        </script>
        <script src="js/B014.js"></script>
            ...
            <div class="row">
                ...
                <div class="col-6 bg-light" id="middle-content">
                    <div class="d-flex justify-content-between mt-3">
                        <button class="btn btn-outline-secondary" onclick="window.location.replace('B007.php')">
