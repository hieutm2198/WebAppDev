...
function addQuestion() {
    ...
    newQuestionContainer.className = "mt-3 mb-2 border-bottom border-gray question-container";
    ...
    for(var i = 0; i < listAnswerOfNewQuestion.length; ++i) {
        ...
        newQuestionContainer.append(checkElement);
        newQuestionContainer.append(answerContent);
        newQuestionContainer.append(newLine);
